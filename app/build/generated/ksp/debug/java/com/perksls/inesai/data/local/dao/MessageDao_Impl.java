  ...
  public MessageDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMessageEntity = new EntityInsertionAdapter<MessageEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `messages` (`id`,`conversationId`,`role`,`content`,`imageBase64`,`fileName`,`fileContent`,`timestamp`,`model`,`provider`) VALUES (?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getFileContent() == null) {
          ...
          statement.bindString(7, entity.getFileContent());
        }
        statement.bindLong(8, entity.getTimestamp());
        if (entity.getModel() == null) {
          statement.bindNull(9);
        } else {
          statement.bindString(9, entity.getModel());
        }
        if (entity.getProvider() == null) {
          statement.bindNull(10);
        } else {
          statement.bindString(10, entity.getProvider());
        }
      }
    };
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"messages"}, new Callable<List<MessageEntity>>() {
      ...
      public List<MessageEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfFileContent = CursorUtil.getColumnIndexOrThrow(_cursor, "fileContent");
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpFileContent;
            if (_cursor.isNull(_cursorIndexOfFileContent)) {
              _tmpFileContent = null;
            } else {
              _tmpFileContent = _cursor.getString(_cursorIndexOfFileContent);
            }
            ...
            _item = new MessageEntity(_tmpId,_tmpConversationId,_tmpRole,_tmpContent,_tmpImageBase64,_tmpFileName,_tmpFileContent,_tmpTimestamp,_tmpModel,_tmpProvider);
            _result.add(_item);
          }
          return _result;
        } finally {
